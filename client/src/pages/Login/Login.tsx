...
export const Login = () => {
  ...
  setTimeout(() => {
    if (imgRef.current !== null) {
      imgRef.current.classList.replace(styles['lazy'], styles['lazy-loaded']);
    }
  }, 300);
  ...
  return (
    <>
      <header>
        <div className='flex items-center justify-center gap-2 text-white py-3 bg-green-800/90'>
      ...
      <main className='bg-gray-100 flex-1'>
        <section className='h-[220px] overflow-hidden bg-[#f6dbc4]'>
          <img
            className={`${styles.lazy} w-full h-full object-cover object-center`}
            src='img/camping.png'
            alt='캠핑'
            ref={imgRef}
          />
        </section>
        <section className='max-w-md mx-auto flex flex-col justify-center px-4 py-7 pb-0'>
      ...
      <footer className='bg-gray-100'>
        <div className='mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 lg:pt-24 py-3 space-y-4'>
          <div>
            <p className='mx-auto max-w-md text-center leading-relaxed text-gray-500 lg:text-left'>
              회원가입은 매우 간단합니다. 로그인을 통해 강력한 TODO 기능들을 경험해보세요! 다양한
              기능들이 무료로 제공됩니다.
            </p>
          </div>
